...
export class ViewProfile extends Component {
  ...
  renderExperience = () => {
    if (this.props.profile.profile.experience) {
      return this.props.profile.profile.experience.map((exp, ind) => {
        let current =
          exp.current == false ? `To ${exp.to}` : "Currently Working";
        return (
  ...
  renderEducation = () => {
    if (this.props.profile.profile.education) {
      return this.props.profile.profile.education.map((edu, ind) => {
        let current =
          edu.current == false ? `To ${edu.to}` : "Currently Attending";
        return (
          <div key={ind} className="eduThumb viewEduThumb">
            <div className="schoolInfoWrap">
              <div className="schoolInfo">
                <span className="schoolField schoolName">{edu.school}</span>
                <span className="studyField schoolField">
                  Studied {edu.fieldOfStudy}
                </span>
              </div>
              <div className="schoolToFrom">
  ...
  renderSocialLinks = () => {
    if (this.props.profile.profile.social) {
      return Object.keys(this.props.profile.profile.social).map(
        (skill, ind) => {
          if (skill === "facebook") {
            return (
              <div key={ind + 1}>
                <a
                  target="_blank"
                  href={this.props.profile.profile.social.facebook}
                >
          ...
          if (skill === "tumblr") {
            return (
              <div key={ind + 1}>
                <a
                  target="_blank"
                  href={this.props.profile.profile.social.tumblr}
                >
          ...
          if (skill === "instagram") {
            return (
              <div key={ind + 1}>
                <a
                  target="_blank"
                  href={this.props.profile.profile.social.instagram}
                >
          ...
          if (skill === "youtube") {
            return (
              <div key={ind + 1}>
                <a
                  target="_blank"
                  href={this.props.profile.profile.social.youtube}
                >
          ...
          if (skill === "twitter") {
            return (
              <div key={ind + 1}>
                <a
                  target="_blank"
                  href={this.props.profile.profile.social.twitter}
                >
          ...
          if (skill === "linkedIn") {
            return (
              <div key={ind + 1}>
                <a
                  target="_blank"
                  href={this.props.profile.profile.social.linkedIn}
                >
              ...
              <div className="spaceForWebsite">
                <div className="basicInfoView">
                  ...
                  <div className="basicInfoWrap">
                    ...
                    <div className="viewInfoF viewProLocation">
                      {profile.location}
                    </div>
                  </div>
                </div>
                <div className="viewInfoF viewProWebsite">
                  {profile.website}
                </div>
              </div>
